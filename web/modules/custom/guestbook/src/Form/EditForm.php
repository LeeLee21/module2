...
/**
 * @file
 * Contains \Drupal\guestform\Form\EditForm.
 */
...
class EditForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $userid = null)
    {
        ...
        $data = $query
          ->select('guestbook', 'g')
          ->condition('g.id', $userid, '=')
          ->fields('g', ['name', 'email','phone_number','response','avatar', 'image', 'id'])
          ->execute()->fetchAll();
        ...
        '#default_value' => $data[0]->phone_number,
        ];
